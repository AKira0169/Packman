...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, username, password) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          return _context.abrupt("return", window.setTimeout(1500));
        case 12:
...
var signUp = exports.signUp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name, username, email, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          if (!(_context2.t0.response.data.error.code === 11000)) {
            _context2.next = 16;
            break;
          }
          if (!_context2.t0.response.data.error.keyValue.email) {
            _context2.next = 13;
            break;
          }
          (0, _alerts.showAlert)('error', "Email Already Exists: ".concat(_context2.t0.response.data.error.keyValue.email));
          return _context2.abrupt("return", window.setTimeout(1500));
        case 13:
          if (!_context2.t0.response.data.error.keyValue.username) {
            _context2.next = 16;
            break;
          }
          (0, _alerts.showAlert)('error', "Username Already Exists: ".concat(_context2.t0.response.data.error.keyValue.username));
          return _context2.abrupt("return", window.setTimeout(1500));
        case 16:
          if (!_context2.t0.response.data.error.errors.passwordConfirm) {
            _context2.next = 19;
            break;
          }
          (0, _alerts.showAlert)('error', _context2.t0.response.data.error.errors.passwordConfirm.message);
          return _context2.abrupt("return", window.setTimeout(1500));
        case 19:
...
},{"./alerts":"alerts.js","axios":"../../../node_modules/axios/index.js"}],"mangeAcc.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateInfo = exports.changePassword = void 0;
var _alerts = require("./alerts");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          (0, _alerts.showAlert)('error', 'Passwords doesnt match');
          return _context.abrupt("return", window.setTimeout(1500));
        case 3:
          _context.prev = 3;
          _context.next = 6;
...
var updateInfo = exports.updateInfo = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name, email) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          ...
          console.log(res);
          if (res.status === 200) {
            (0, _alerts.showAlert)('success', 'Data changed successfully');
            window.setTimeout(function () {
              location.assign('/test');
            }, 1500);
          }
  ...
  return function updateInfo(_x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
},{"./alerts":"alerts.js","axios":"../../../node_modules/axios/index.js"}],"itemManage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.makeNewOrder = exports.editItem = exports.deleteProduct = exports.deleteOrder = exports.addNewItem = void 0;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint -disable */
var addNewItem = exports.addNewItem = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, price, quantity) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Item created successfully');
            window.setTimeout(function () {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', _context.t0.response.data);
          return _context.abrupt("return", window.setTimeout(function () {
            location.assign('/');
          }, 1500));
        case 12:
        case "end":
  ...
  return function addNewItem(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
var makeNewOrder = exports.makeNewOrder = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(quantity, toWhom, serial) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://127.0.0.1:8000/api/v1/orders/create-new-order/".concat(serial),
            data: {
              quantity: quantity,
              toWhom: toWhom
            }
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Order Placed successfully');
            window.setTimeout(function () {
              location.assign('/products');
            }, 1500);
          }
        ...
        case 7:
          _context2.prev = 7;
          _context2.t0 = _context2["catch"](0);
          if (!(_context2.t0.response.status === 405)) {
            _context2.next = 12;
            break;
          }
          ...
          return _context2.abrupt("return", window.setTimeout(1500));
        case 12:
          if (_context2.t0.response.status === 429) {
            (0, _alerts.showAlert)('error', _context2.t0.response.data);
  ...
  return function makeNewOrder(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
var deleteProduct = exports.deleteProduct = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(serial) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:8000/api/v1/inventory/delete-product/".concat(serial),
            data: {
              serial: serial
            }
          });
        case 3:
          res = _context3.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Product Deleted successfully');
            window.setTimeout(function () {
  ...
  return function deleteProduct(_x7) {
    return _ref3.apply(this, arguments);
  };
}();
var deleteOrder = exports.deleteOrder = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(serial) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:8000/api/v1/orders/delete-order/".concat(serial),
            data: {
              serial: serial
            }
          });
        case 3:
          res = _context4.sent;
          if (res.status === 204) {
            (0, _alerts.showAlert)('success', 'Order Deleted successfully');
            window.setTimeout(function () {
              location.reload(true);
            }, 1500);
          }
...
var editItem = exports.editItem = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(name, price, quantity, serial) {
    var res;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8000/api/v1/inventory/edit-product/".concat(serial),
            data: {
              name: name,
              price: price,
              quantity: quantity
        ...
        case 3:
          res = _context5.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Item has been edited successfully');
            window.setTimeout(function () {
              location.assign('/products');
            }, 1500);
          }
  ...
  return function editItem(_x9, _x10, _x11, _x12) {
    return _ref5.apply(this, arguments);
  };
}();
},{"./alerts.js":"alerts.js","axios":"../../../node_modules/axios/index.js"}],"search.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.productSearchResult = exports.orderSearchResult = exports.emptySearch = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _itemManage = require("./itemManage.js");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw new Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw new Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var emptySearch = exports.emptySearch = /*#__PURE__*/function () {
  ...
  return function emptySearch() {
    return _ref.apply(this, arguments);
  };
}();
var orderSearchResult = exports.orderSearchResult = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(input) {
    var pagination, res, _tableBody, deleteButton, confirmYes, confirmNo, tableBody, serial, user, coulm;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
        ...
        case 5:
          ...
          _tableBody = document.querySelector('.table');
          _tableBody.innerHTML = '<p class="text-center">Sorry no results</p>';
        ...
        case 10:
          ...
          tableBody.innerHTML = '';
          user = res.data.user;
          coulm = document.createElement('thead');
          coulm.innerHTML = "\n      <tr>\n      <th>Num</th>\n      <th>Name of client</th>\n      <th>Product</th>\n      <th>Sold By</th>\n      <th>Quantity</th>\n      <th>Price</th>\n      <th>History</th>\n      <th>Total</th>\n      <th>Actions</th></tr>";
          Array.from(res.data.orders).forEach(function (order, index) {
            var row = document.createElement('tbody');
            row.classList;
            row.innerHTML = "\n          <th scope='row'>".concat(index + 1, "</th>\n            <td>").concat(order.toWhom, "</td>\n            <td>").concat(order.name, "</td>\n            <td>").concat(order.createdBy, "</td>\n            <td>").concat(order.quantity, "</td>\n            <td>").concat(order.price, "</td>\n            <td>").concat(order.createdAt, "</td>\n            <td>").concat(order.price * order.quantity, " L.E</td>\n            <td>\n              ").concat(user.role === 'admin' ? "<button class='bttn button deleteButton deleteButton' type='button' data-serial='".concat(order.serial, "'>\u274C</button>") : '', "\n            </td>\n          ");
            ...
            Array.from(deleteButton).forEach(function (element) {
              ...
              confirmYes.addEventListener('click', function (e) {
                (0, _itemManage.deleteOrder)(serial);
  ...
  return function orderSearchResult(_x) {
    return _ref2.apply(this, arguments);
  };
}();
var productSearchResult = exports.productSearchResult = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(input) {
    var pagination, res, _tableBody2, deleteButton, confirmYes, confirmNo, tableBody, serial, user, coulm;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
        ...
        case 5:
          ...
          _tableBody2 = document.querySelector('.table');
          _tableBody2.innerHTML = '<p class="text-center">Sorry no results</p>';
        ...
        case 10:
          ...
          coulm = document.createElement('thead');
          coulm.innerHTML = "\n      <tr>\n      <th>Num</th>\n      <th>Product</th>\n      <th>Quantity</th>\n      <th>Price</th>\n      <th>Added at</th>\n      <th>Avaliable</th>\n      <th>Actions</th></tr>";
          Array.from(res.data.products).forEach(function (product, index) {
            var row = document.createElement('tbody');
            row.classList;
            row.innerHTML = "\n        <th scope='row'>".concat(index + 1, "</th>\n          <td>").concat(product.name, "</td>\n          <td>").concat(product.quantity, "</td>\n          <td>").concat(product.price, "</td>\n          <td>").concat(product.addedAt, "</td>\n          <td>").concat(product.status === 'In Stock' ? '<div class="inStock">In stock</div>' : '<div class="outofStock">Out of stock</div>', "</td>\n          <td>\n            <a class='button bttn actions button' href='/make-order/").concat(product.serial, "'>\u2795</a>\n            <a class='button bttn actions button' href='#'>\uD83D\uDED2</a>\n            ").concat(user.role === 'admin' ? "<a class='button bttn actions button' href='/edit-item/".concat(product.serial, "'>\u270F\uFE0F</a>") : '', "\n            ").concat(user.role === 'admin' ? "<button class='bttn actions button deleteButton deleteButton' type='button' data-serial='".concat(product.serial, "'>\u274C</button>") : '', "\n          </td>\n        ");
            tableBody.appendChild(coulm);
            tableBody.appendChild(row);
            Array.from(deleteButton).forEach(function (element) {
              element.addEventListener('click', function (e) {
              ...
              confirmYes.addEventListener('click', function (e) {
                (0, _itemManage.deleteProduct)(serial);
                confirmationDialog.classList.add('hidden');
              });
              confirmNo.addEventListener('click', function (e) {
                confirmationDialog.classList.add('hidden');
  ...
  return function productSearchResult(_x2) {
    return _ref3.apply(this, arguments);
  };
}();
},{"axios":"../../../node_modules/axios/index.js","./itemManage.js":"itemManage.js"}],"cart.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createOrderCart = exports.cartPageRend = void 0;
var _alerts = require("./alerts.js");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint -disable */
var cartPageRend = exports.cartPageRend = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(cart) {
    var queryString, res, newHTML, parser, newDocument;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          queryString = "?cart=".concat(JSON.stringify(cart));
          _context.next = 4;
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/cart".concat(queryString),
            data: {
              cart: cart
            }
          });
        case 4:
          res = _context.sent;
          newHTML = res.data; // Create a new HTML document
          parser = new DOMParser();
          newDocument = parser.parseFromString(newHTML, 'text/html'); // Replace the current document with the new one
          document.open();
  ...
  return function cartPageRend(_x) {
    return _ref.apply(this, arguments);
  };
}();
var createOrderCart = exports.createOrderCart = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.status === 201) {
            (0, _alerts.showAlert)('success', 'Orders Placed successfully');
            window.setTimeout(function () {
              location.assign('/products');
            }, 1500);
          }
  ...
  return function createOrderCart(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
},{"./alerts.js":"alerts.js","axios":"../../../node_modules/axios/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _mangeAcc = require("./mangeAcc.js");
var _itemManage = require("./itemManage.js");
...
var loginfunc = document.querySelector('.loginform');
var signUpForm = document.querySelector('.form--signup');
var logOut = document.querySelector('.logoutBtn');
var addNewItemForm = document.querySelector('.form--newItem');
var makeNewOrderForm = document.querySelector('.form--newOrder');
var changePasswordForm = document.querySelector('.changePassword');
var changeInfoForm = document.querySelector('.changeinfo');
var editItemForm = document.querySelector('.form--editItem');
var submitButtonNewProduct = document.getElementById('submit-button-newProduct');
var submitButtonMakeOrder = document.getElementById('submit-button-makeOrder');
var submitButtonCart = document.getElementById('submit-button-cart');
...
var cartBttn = document.getElementsByClassName('cartBttn');
var cartPage = document.getElementById('cartPage');
var serial;
var cart = [];
if (priceTotal) {
  priceTotal.addEventListener('keyup', function (e) {
    e.preventDefault();
    var pricee = document.querySelector('.price-order').placeholder;
    document.querySelector('.price-order').value = pricee.split('/')[0] * e.target.value + '/L.E';
  });
}
if (cartBttn) {
  Array.from(cartBttn).forEach(function (cartButton) {
    cartButton.addEventListener('click', /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              productSerial = cartButton.getAttribute('data-serial');
              (0, _alerts.showAlert)('success', 'Product added to cart successfully');
...
if (searchInput) {
  searchInput.addEventListener('keyup', function (e) {
    ...
    var inputElement = document.getElementById('search-box').value;
    if (searchInput.value == '') {
      return (0, _search.emptySearch)();
    }
    if (url === 'products') {
      return (0, _search.productSearchResult)(inputElement);
    }
    if (url === 'orders') {
      return (0, _search.orderSearchResult)(inputElement);
    }
  });
}
if (changePasswordForm) {
  changePasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _mangeAcc.changePassword)(currentPassword, newPassword, confirmPassword);
  });
}
if (loginfunc) {
  loginfunc.addEventListener('submit', function (e) {
    e.preventDefault();
    var inputElement = document.getElementById('email').value;
    var inputValue = inputElement.trim();
    var password = document.getElementById('password').value;
    if (inputValue) {
      if (isEmail(inputValue)) {
        var email = inputValue;
        (0, _login.login)(email, null, password);
      } else {
        var username = inputValue;
        (0, _login.login)(null, username, password);
      }
    }
  });
}
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    ...
    (0, _login.signUp)(name, userName, email, password, passwordConfirm);
  });
}
if (logOut) {
...
if (addNewItemForm) {
  addNewItemForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 5;
            _context2.next = 8;
            return (0, _itemManage.addNewItem)(name, price, quantity);
          case 8:
            _context2.next = 12;
            break;
          case 10:
...
if (makeNewOrderForm) {
  makeNewOrderForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var url, OrderSerial, orderQuantity, toWhom;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            url = window.location.href;
            OrderSerial = url.substring(url.lastIndexOf('/') + 1);
            orderQuantity = document.getElementById('order-quantity').value;
            toWhom = document.getElementById('order-toWhom').value;
            submitButtonMakeOrder.disabled = true;
            _context3.prev = 6;
            _context3.next = 9;
            return (0, _itemManage.makeNewOrder)(orderQuantity, toWhom, OrderSerial);
          case 9:
            _context3.next = 13;
            break;
          case 11:
...
if (cartForm) {
  var productsName = document.querySelectorAll('#cart-product-name');
  var productsQuantitie = document.querySelectorAll('#cart-product-quantity');
  var productsPrice = document.querySelectorAll('#cart-product-price');
  var productsTotal = document.querySelectorAll('.product-total');
  var itemsSerial = document.querySelectorAll('.deleteButton');
  var products = [];
  var updateTotal = function updateTotal() {
    var overallTotal = 0;
    for (var i = 0; i < productsName.length; i++) {
      var quantity = parseInt(productsQuantitie[i].value, 10);
      if (isNaN(quantity) || quantity < 0) {
        quantity = 0;
      }
      var price = parseFloat(productsPrice[i].value);
    ...
    if (totalElement) {
      totalElement.textContent = "Total: ".concat(overallTotal.toFixed(2), " L.E ");
    }
  };
  updateTotal();
  Array.from(productsQuantitie).forEach(function (element) {
    element.addEventListener('keyup', updateTotal);
  });
  cartForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
      var i, _serial, quantity, toWhom, product;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            e.preventDefault();
            for (i = 0; i < productsName.length; i++) {
              _serial = itemsSerial[i].getAttribute('data-serial');
              quantity = parseInt(productsQuantitie[i].value, 10);
              toWhom = document.getElementById('order-toWhom').value;
              product = {
                quantity: quantity,
                serial: _serial,
            ...
            _context4.prev = 2;
            _context4.next = 5;
            return (0, _cart.createOrderCart)(products);
          case 5:
            _context4.next = 9;
            break;
          case 7:
...
if (editItemForm) {
  editItemForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var url = window.location.href;
    var itemSerial = url.substring(url.lastIndexOf('/') + 1);
    var name = document.getElementById('product-name').value;
    var price = document.getElementById('price').value;
    var quantity = document.getElementById('item-quantity').value;
    (0, _itemManage.editItem)(name, price, quantity, itemSerial);
  });
}
if (changeInfoForm) {
  changeInfoForm.addEventListener('submit', function (e) {
    ...
    (0, _mangeAcc.updateInfo)(name, email);
  });
}
Array.from(deleteButton).forEach(function (element) {
  element.addEventListener('click', function (e) {
